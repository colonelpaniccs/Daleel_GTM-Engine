...
| Manual signal submission               | Slack-based intake enables team members to submit signals into the evaluation pipeline | This is the mechanism for automating on-demand enrichment, for a newly discovered company or one the team already knows. |
